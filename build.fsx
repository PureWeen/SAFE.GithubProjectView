...
Target.create "Bundle" (fun _ ->
    ...
    IO.File.Delete "appsettings.Development.json"
    IO.File.Delete (Path.combine deployDir "appsettings.Development.json")
)
...
Target.create "ArmTemplate" (fun _ ->
    ...
    let deployment =
        let location = Environment.environVarOrDefault "location" Region.USEast.Name
